...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(o.compareTo(p1));
        System.out.println(o.slopeTo(o));
        System.out.println(o.slopeTo(p1));
        System.out.println(o.slopeTo(p2));
        System.out.println(o.slopeTo(p3));
        System.out.println(o.slopeTo(p4));

        Point[] points = { o, p1, p2, p3, p4 };
